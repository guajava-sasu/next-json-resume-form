...
export const metadata: Metadata = {
  title:
    "JSON Resume Builder - Créateur de CV en ligne gratuit | Format JSON Resume Standard",
  description:
    "Créez facilement votre CV professionnel au format JSON Resume, le standard ouvert reconnu. Outil gratuit en ligne pour générer, éditer et exporter votre CV au format JSON Resume. Bientôt: conversion automatique de CV Word et PDF via IA.",
  keywords: [
    "json resume",
    "jsonresume",
    "cv json",
    ...
    "cv format json",
    "créateur cv json",
    "json resume français",
    "json resume schema",
    "json resume standard",
    "cv professionnel json",
    "générateur cv json",
    "json resume online",
    "json resume editor",
  ],
  ...
  openGraph: {
    ...
    description:
      "Créez votre CV professionnel au format JSON Resume, le standard ouvert reconnu",
    type: "website",
    locale: "fr_FR",
  ...
  alternates: {
    //TODO: transformer avec le domaine final lors du déploiement
